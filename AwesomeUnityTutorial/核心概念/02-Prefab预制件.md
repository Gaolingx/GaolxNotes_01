# 【百日挑战16】unity核心概念之Prefab预制件

前言：通过前面关于创作者套件Creator kit FPS的几个教程，我们对3D游戏的制作流程有了大概的了解，我们学习了如何在3D视图中选中游戏对象，坐标轴的移动旋转，引入了一些相关概念（绝对位置和相对位置等），学会了如何对游戏对象进行分组，如何用项目提供的关卡编辑脚本来制作关卡，编辑预制件制作敌人，设计武器绑定给玩家，设置钥匙与门，设置游戏终结条件，项目的构建与运行等等，而下一步我们就要逐渐开始接触基本的c#脚本编程了，今天先让我们学习unity的核心概念之——Prefab（预制件）。
...
![](../官方教程项目系列/imgs/0909/image%20(1).png)
...
![](../官方教程项目系列/imgs/0909/image%20(2).png)

也可以在这个 Overrides 菜单中，选择单项，进行逐项操作

![](../官方教程项目系列/imgs/0909/image%20(3).png)
...
![](../官方教程项目系列/imgs/0909/image%20(4).png)
...
![](../官方教程项目系列/imgs/0909/image%20(5).png)
...
![](../官方教程项目系列/imgs/0909/image%20(6).png)
