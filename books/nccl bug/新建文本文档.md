...
笔者在尝试方法一：在grub中关闭iommu后重启系统，由于 `Above 4G Decoding` 和 `Resizable BAR` 在server平台bios上默认开启，因此问题解决，再次运行sft trainer很快就完成了多卡初始化进入到wandb login和dataset loading。

可以看到训练开始前的 ring 建立阶段nccl输出以下info：

```
jk01:59096:60824 [3] NCCL INFO Channel 01/1 : 3[3] -> 0[0] via P2P/CUMEM
jk01:59095:60827 [2] NCCL INFO Channel 01/1 : 2[2] -> 0[0] via P2P/CUMEM
jk01:59096:60824 [3] NCCL INFO Channel 03/1 : 3[3] -> 0[0] via P2P/CUMEM
jk01:59095:60827 [2] NCCL INFO Channel 03/1 : 2[2] -> 0[0] via P2P/CUMEM
jk01:59094:60825 [1] NCCL INFO Channel 00/1 : 1[1] -> 0[0] via P2P/CUMEM
jk01:59094:60825 [1] NCCL INFO Channel 02/1 : 1[1] -> 0[0] via P2P/CUMEM
jk01:58590:60831 [0] NCCL INFO Channel 01/1 : 0[0] -> 1[1] via P2P/CUMEM
jk01:58590:60831 [0] NCCL INFO Channel 03/1 : 0[0] -> 1[1] via P2P/CUMEM
jk01:58590:60831 [0] NCCL INFO Channel 01/1 : 0[0] -> 2[2] via P2P/CUMEM
jk01:58590:60831 [0] NCCL INFO Channel 03/1 : 0[0] -> 2[2] via P2P/CUMEM
jk01:58590:60831 [0] NCCL INFO Channel 00/1 : 0[0] -> 3[3] via P2P/CUMEM
jk01:58590:60831 [0] NCCL INFO Channel 02/1 : 0[0] -> 3[3] via P2P/CUMEM
```

全部四条 rank 间的连接都是 `via P2P/CUMEM`，没有掉到 `via SHM` 或者走网络（IB）传输，说明卡间通信确实走的是 PCIe/NVLink 的直连 P2P 路径，而不是绕经 host memory 或 RDMA 网卡。
